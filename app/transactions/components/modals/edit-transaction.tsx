...
export function EditTransaction({
  ...
  const form = useForm<TransactionEditFormValues>({
    ...
    defaultValues: {
      ...
      category_id: transaction.category_id !== null ? Number(transaction.category_id) : null,

      target_account_id:
        transaction.target_account_id !== null ? Number(transaction.target_account_id) : null,
    },
    mode: "onChange",
  ...
  const handleEdit = async (values: TransactionEditFormValues) => {
    ...
    const payload: Partial<DbTransaction> = {
      title: values.title,
      type: values.type,
  ...
  const [currentType, setCurrentType] = useState<TransactionType>(
    (transaction.type ?? "expense") as TransactionType
  );
