  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap hover:cursor-pointer rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        icon: "border-none bg-background shadow-xs hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:hover:bg-input/50",

        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost: "hover:bg-accent hover:text-accent-foreground dark:hover:bg-accent/50",
        link: "text-primary underline-offset-4 hover:underline",
        icon_transitions:
          "px-3 size-20 rounded-xl md:size-9 md:rounded-sm order-2 fixed z-100 md:z-0  md:static bottom-6 right-6 text-text-add-button bg-secondary-foreground text-background md:border md:border-border md:bg-background md:shadow-xs md:hover:bg-accent md:hover:text-accent-foreground md:dark:bg-input/30 md:dark:hover:bg-input/50 md:text-foreground",
      },
      size: {
