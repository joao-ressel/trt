...
export default function AddAccountForm() {
  ...
  async function onSubmit(data: AccountFormValues) {
    const amountFloat = parseFloat(data.inicial_balance);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button variant="outline" className="order-2 md:sticky fixed bottom-6 right-6">
          <Plus /> <p className="md:hidden">Add Account</p>
        </Button>
      </DialogTrigger>
      <DialogContent>
        <Form {...form}>
